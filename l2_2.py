...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.x1DoubleSpinBox.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.y1DoubleSpinBox.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.x2SpinBox.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.y2DoubleSpinBox.setCursor(QtGui.QCursor(QtCore.Qt.ArrowCursor))
        ...
        self.colorLabel.setGeometry(QtCore.QRect(0, 6, 41, 16))
        font = QtGui.QFont()
        font.setPointSize(15)
        ...
        self.colorPushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.colorPushButton.setObjectName("colorPushButton")
        self.graphicsView_2 = QtWidgets.QGraphicsView(self.frame_3)
        self.graphicsView_2.setGeometry(QtCore.QRect(50, 5, 20, 20))
        self.graphicsView_2.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.ForbiddenCursor))
        ...
        self.drawPushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.savePushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        ...
        self.erasePushButton.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.drawPushButton.setText(_translate("MainWindow", "Draw ellipse"))
